...
// PLATFORM 2 - BACKEND ORDER SUBMISSION (OPTIMIZED FOR INSTANT RESPONSE)
function sendOrderToTelegram() {
  ...
  // Instantly show success popup and close checkout without blocking UI
  showModernPopup(
    "Success!",
  ...
  // Send data to backend asynchronously in the background (Non-blocking)
  fetch(
  ...
  .catch(error => {
    console.error("Platform 2 Background Sync Error:", error);
  });
}
