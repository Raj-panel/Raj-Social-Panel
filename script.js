...
function showCheckoutOverlay() {
    ...
    if (!document.getElementById("ultraCompactCss")) {
        ...
        style.innerHTML = `
            ...
            #checkoutPage input { padding: 4px 8px !important; font-size: 16px !important; height: 32px !important; }
            #checkoutUpiView { padding: 4px !important; margin-bottom: 4px !important; text-align: center; }
            #checkoutUpiView img { width: 110px !important; height: 110px !important; margin: 1px auto !important; background: #fff; padding: 1px; border-radius: 2px; }
