...
facebook: {
    ...
    // Facebook Comments - Package Based Service
    "Facebook Comments": [
    ...
    // Facebook Shares - Package Based Service
    "Facebook Shares": [
...
const iconClass = currentPlatform === 'instagram'
    ? 'fa-instagram'
    : 'fa-facebook';
    ...
    if (pkg.type === "custom") {
        ...
        customDiv.innerHTML = `
            <div style="margin-bottom: 8px;">
                <strong style="color: #a855f7; font-size: 13px;">
                    ${pkg.name} (Custom Qty)
                </strong>
            ...
            <div class="input-box">
                <input
                    ...
                    oninput="calculateCustomPrice('${pkg.name}', ${pkg.pricePer1000})"
                >
            </div>

            <div
                style="font-size: 12px; font-weight: 800; color: #22c55e;"
            ...
            <div class="pkg-left">
                ...
                <div class="pkg-info">
                    ...
                    <div class="pkg-title">
                        ...
                        ${
                            pkg.badge
                            ? `<span class="pkg-badge ${pkg.badgeClass || 'badge-popular'}">
                                ${pkg.badge}
                               </span>`
                            : ''
                        }
...
```
const qty =
    parseInt(document.getElementById("customQtyInput").value) || 0;
...
const upiUrl =
    `upi://pay?pa=${upiId}&pn=${encodeURIComponent(payeeName)}&am=${totalPrice}&cu=INR`;
...
const usdtAmount =
    (selectedPackage.price / 96).toFixed(2);
...
document.getElementById("upiPaymentView").style.display =
    method === 'upi'
    ? "block"
    : "none";


document.getElementById("binancePaymentView").style.display =
    method === 'binance'
    ? "block"
    : "none";


document.getElementById("tabUpi").classList.toggle(
    "active",
    method === 'upi'
);


document.getElementById("tabBinance").classList.toggle(
    "active",
    method === 'binance'
);
...
const utrLabel =
    document.getElementById("utrLabel");
...
if (method === 'upi') {
    ...
    utrInput.placeholder =
        "e.g. 21893XXXXXXXX (Binance TxID)";
}
```
