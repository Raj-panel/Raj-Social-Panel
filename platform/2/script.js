...
// PLATFORM 2 - INSTANT BACKGROUND ORDER SUBMISSION (No Delay)
async function sendOrderToTelegram() {
  ...
  // 1. Instantly save order locally and show success popup without waiting for network response
  const localOrder = {
  ...
  // 2. Send request to backend in the background (Non-blocking)
  fetch(
