...
```
    ...
    // ==========================================
    "Shares Lifetime": [
        { providerId: 450, name: "100 Shares", price: 10, badge: "Starter", badgeClass: "badge-demo" },
        { providerId: 450, name: "1K Shares", price: 30, badge: "Fast", badgeClass: "badge-popular" },
        { providerId: 450, name: "5K Shares", price: 69, badge: "🔥 Best Value", badgeClass: "badge-best" },
        { providerId: 450, name: "10K Shares", price: 99, badge: "👑 Most Popular", badgeClass: "badge-best" }
    ]
},
...
packages.forEach((pkg) => {
    ...
    if (pkg.type === "custom") {
        ...
        const customInput =
            customDiv.querySelector("#customQtyInput");
        ...
        customInput.addEventListener("input", function () {
            ...
            calculateCustomPrice(
                ...
                pkg.providerId,
                customInput,
                customDiv.querySelector("#customPriceDisplay")
            );
...
showCheckoutSummary(
    pkgData.name,
    Number(pkgData.price).toFixed(2)
);
```
...
// ==========================================
// NOTE:
// This is the old manual WhatsApp flow.
// Automatic payment gateway integration
// will replace this function later.
// ==========================================
...
const waMsg =
    ...
    `*Provider ID:* ${selectedPackage.providerId || "Not Assigned"}%0A` +
